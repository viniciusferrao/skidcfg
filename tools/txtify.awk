...
#
# Shared with skidpack, where it was written and where the same job comes up.
# Kept as a copy rather than a submodule: it is a hundred lines of awk with no
# dependencies, and a release that will not build because a submodule did not
# clone is a worse problem than two copies of a hundred lines.
#
